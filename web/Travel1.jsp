<%-- 
    Document   : Travel1
    Created on : 16 Jan, 2026, 6:17:16 PM
    Author     : neethu
--%>
...
<html>
    <head>
        ...
        <style>
            ...
            .parent-container:hover #profile {
                display: block;   
            }
            #p_profile{
                width: 110px;
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark " style="background-color: white">
            <h5 class="navbar-brand" href="#" style="color: rgb(3, 3, 136); font-size: 50px; position: relative; left: 530px; bottom: 3px;">Trip.com</h5>
            ...
            <svg id="svg" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-fill" viewBox="0 0 16 16">
                <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6"/>
            </svg>
            <div id="profile">
                <p id="p_profile">Neethu Krishna</p>
                <hr style="position: relative; bottom: 13px;">
                <a href="http://localhost:8080/Travel/trip.jsp" id="logout">Log Out</a>
            </div>
            </div>
        </nav>
        <div id="main1">
